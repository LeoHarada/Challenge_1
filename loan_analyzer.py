...
print (f"The total sum of all loans in the list is", sum_of_loans)
...
print(f"The total average of all loans in the list is", average_loan_amount)
...
print(f"The repayment interval is", repayment_interval)
...
print(f"The present_value of the loan is", present_value)
...
if present_value >= loan_price:
    ...
    print("The loan is too expensive and not worth the cost.")
...
def new_loan_present_value(future_value, remaining_months, annual_discount_rate):
    present_value = future_value/(1+(annual_discount_rate/12)) **remaining_months
    return present_value

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
present_value = new_loan_present_value(future_value=1000, remaining_months=12, annual_discount_rate=.2)
